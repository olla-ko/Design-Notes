$(document).ready(function() {
    ...
    $('body').append('<footer><div class="gradient-divider" style="height: 2px;></div><div class="facepalm"></div><div class="footer-content"><a href="mailto:to.olga.konovalova@gmail.com">to.olga.konovalova@gmail.com</a></div></footer>');

    if (!window.location.href.endsWith('research.html')) {
